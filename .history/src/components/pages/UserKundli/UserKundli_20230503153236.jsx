  ...
  const addCategory = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://ou6tgbmd2b.execute-api.ap-south-1.amazonaws.com/dev/api/v1/vender/categories/new",
        { parentCategory },
        Auth
      );
  ...
  const Category = async () => {
    ...
    try {
      const { data } = await axios.get(
        "https://ou6tgbmd2b.execute-api.ap-south-1.amazonaws.com/dev/api/v1/vender/categories",
        Auth
      );
      setData(data);
      setLoading(false);
  ...
  const deleteCategory = async (id) => {
    try {
      const data = await axios.delete(
        `https://ou6tgbmd2b.execute-api.ap-south-1.amazonaws.com/dev/api/v1/vender/categories/${id}`,
        Auth
      );
