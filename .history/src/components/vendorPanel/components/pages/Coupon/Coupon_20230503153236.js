  ...
  const addCoupon = async (e) => {
    ...
    try {
      const data = await axios.post(
        "https://ou6tgbmd2b.execute-api.ap-south-1.amazonaws.com/dev/api/v1/coupon",
        form,
        Auth
      );
  ...
  const Coupon = async () => {
    ...
    try {
      const { data } = await axios.get(
        "https://ou6tgbmd2b.execute-api.ap-south-1.amazonaws.com/dev/api/v1/coupon/all",
        Auth
      );
      setData(data);
      setLoading(false);
  ...
  const deleteCoupon = async (id) => {
    try {
      const data = await axios.delete(
        `https://ou6tgbmd2b.execute-api.ap-south-1.amazonaws.com/dev/api/v1/coupon/${id}`,
        Auth
      );
