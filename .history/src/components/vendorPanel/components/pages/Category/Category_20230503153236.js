  ...
  const addCategory = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://ou6tgbmd2b.execute-api.ap-south-1.amazonaws.com/dev/api/v1/admin/category/new",
        { parentCategory },
        auth
      );
  ...
  const deleteCategory = async (id) => {
    ...
    try {
      const data = await axios.delete(
        `https://ou6tgbmd2b.execute-api.ap-south-1.amazonaws.com/dev/api/v1/admin/category/${id}`,
        auth
      );
