  ...
  const addSub = async (e) => {
    ...
    try {
      const data = await axios.post(
        "https://ou6tgbmd2b.execute-api.ap-south-1.amazonaws.com/dev/api/v1/admin/subCategory/new",
        form,
        Auth
      );
  ...
  const subCategory = async () => {
    ...
    try {
      const { data } = await axios.get(
        "https://ou6tgbmd2b.execute-api.ap-south-1.amazonaws.com/dev/api/v1/admin/subCategory",
        Auth
      );
      setData(data);
      setLoading(false);
